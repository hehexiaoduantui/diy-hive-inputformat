...
public class DIYLineRecordReader implements RecordReader<LongWritable, Text> {
    private static final Logger LOG =
            LoggerFactory.getLogger(DIYLineRecordReader.class.getName());
    ...
    public DIYLineRecordReader(Configuration job,
                               FileSplit split) throws IOException {
        this(job, split, null);
    }

    public DIYLineRecordReader(Configuration job, FileSplit split,
                               byte[] recordDelimiter) throws IOException {
    ...
    public DIYLineRecordReader(InputStream in, long offset, long endOffset,
                               int maxLineLength) {
